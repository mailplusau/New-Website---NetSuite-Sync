  ...
  if (request.getMethod() == "GET") {
    ...
    if (isNullorEmpty(postcode)) {
      ...
      if (!isNullorEmpty(parent_lpo)) {
        ...
        resultSetlpoProfileLeadsListSearch.forEachResult(
          function (lpoProfileLeadsListSearchResultSet) {
      ...
      var salesRepRandomAssignResponse = nlapiRequestURL(
      ...
      nlapiLogExecution(
        "DEBUG",
        "New Lead Sales Rep Assigned JSON",
        leadSalesRepAssignedJSON.internalid
      );
      ...
      var salesRecord = nlapiLoadRecord(
        "customrecord_sales",
        salesRecordInternalID
      );
      salesRecord.setFieldValue("custrecord_sales_assigned", salesRep);
      ...
      var nsZoneID = 4;
      sendleZoneIDSearchResult.forEachResult(
        function (sendleZoneIDSearchResultSet) {
      ...
      std250gGoldItemPricingSearchResult.forEachResult(
        function (std250gGoldItemPricingSearchResultSet) {
      ...
      std500gGoldItemPricingSearchResult.forEachResult(
        function (std500gGoldItemPricingSearchResultSet) {
      ...
      std1kgGoldItemPricingSearchResult.forEachResult(
        function (std1kgGoldItemPricingSearchResultSet) {
      ...
      std3kgGoldItemPricingSearchResult.forEachResult(
        function (std3kgGoldItemPricingSearchResultSet) {
      ...
      std5kgGoldItemPricingSearchResult.forEachResult(
        function (std5kgGoldItemPricingSearchResultSet) {
      ...
      std10kgGoldItemPricingSearchResult.forEachResult(
        function (std10kgGoldItemPricingSearchResultSet) {
      ...
      std20kgGoldItemPricingSearchResult.forEachResult(
        function (std20kgGoldItemPricingSearchResultSet) {
      ...
      std25kgGoldItemPricingSearchResult.forEachResult(
        function (std25kgGoldItemPricingSearchResultSet) {
      ...
      premium10kgItemPricingSearchResult.forEachResult(
        function (premium10kgItemPricingSearchResultSet) {
      ...
      premium20kgItemPricingSearchResult.forEachResult(
        function (premium20kgItemPricingSearchResultSet) {
      ...
      premium1kgItemPricingSearchResult.forEachResult(
        function (premium1kgItemPricingSearchResultSet) {
      ...
      premium3kgItemPricingSearchResult.forEachResult(
        function (premium3kgItemPricingSearchResultSet) {
      ...
      premium5kgItemPricingSearchResult.forEachResult(
        function (premium5kgItemPricingSearchResultSet) {
