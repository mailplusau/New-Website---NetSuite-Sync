    ...
    function leadForm(request, response) {
        if (request.getMethod() == "GET") {
            ...
            if (isNullorEmpty(postcode)) {
                ...
                var hear_about_us = customer_record.getFieldValue('custentity_how_did_you_hear_about_us');
                var interests = customer_record.getFieldValue('custentity_services_of_interest');
