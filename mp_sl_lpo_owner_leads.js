 ...
 * Modified on:          2025-02-27T20:38:52.699Z
...
function leadForm(request, response) {
	if (request.getMethod() == "GET") {
        ...
        if (isNullorEmpty(postcode)) {
			...
			lpoLeadrecord.setFieldValue(
				"custrecord_lpo_lead_contact_name",
				lpo_owner_name
			);
			lpoLeadrecord.setFieldValue("custrecord_lpo_lead_contact_email", email);
			lpoLeadrecord.setFieldValue(
				"custrecord_lpo_lead_contact_number",
				phone_number
			);
			...
			lpoLeadrecord.setFieldValue(
				"custrecord_lpo_lead_address_level",
				address1
			);
			lpoLeadrecord.setFieldValue("custrecord_lpo_lead_address_suburb", city);
			lpoLeadrecord.setFieldValue(
				"custrecord_lpo_lead_address_state",
				state_id
			);
			lpoLeadrecord.setFieldValue(
				"custrecord_lpo_lead_address_postcode",
				postcode
			);
			lpoLeadrecord.setFieldValue("custrecord_lpo_lead_status", 1);
			lpoLeadrecord.setFieldValue(
				"custrecord_webpage_url_source",
				splitPageURL[1]
			);
