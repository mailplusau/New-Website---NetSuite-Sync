...
define([
	...
	function onRequest(context) {
		...
		if (context.request.method === "GET") {
			...
			//HEADER NAVBAR
			inlineHtml +=
				'<div class="container nav" style="width: 100%"> <div class="col-xs-4"><ul class="nav-links"> <li><a href="#" style="color: #ffffff !important;font-size: 1.25em;">Our Service</a></li> <li><a href="#" style="color: #ffffff !important;font-size: 1.25em;">Tracking</a></li> <li><a href="#" style="color: #ffffff !important;font-size: 1.25em;">For Small Business</a></li> </ul></div> <div class="logo-holder col-xs-4"> <img src="https://mailplus.com.au/wp-content/uploads/2021/02/mailplus-new-logo-solo-copy-4.png" alt="Company Logo" class="logo"> </div> <div class="col-xs-4" style="text-align: right;"><i class="fa badge fa-lg viewCart" id="card-qty" value="0" style="cursor: pointer;">&#xf07a;</i></div> </div>';
			...
			redirect.redirect({
				url:
					"https://1048144.extforms.netsuite.com/app/site/hosting/scriptlet.nl?script=1920&deploy=1&compid=1048144&ns-at=AAEJ7tMQcFOhoMUAM3TtOt9sQSedw4BWg2xTxY248eAFw7z9yEI&custid=" +
					customerInternalId +
					"&invid=" +
					invoiceInternalId +
					"&email=" +
